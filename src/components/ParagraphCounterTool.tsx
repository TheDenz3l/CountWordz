...
export default function ParagraphCounterTool() {
  ...
  const handleSampleText = () => setText("This is the first paragraph.\n\nThis is the second paragraph with more content.\n\nAnd this is the third paragraph.");
  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-3 gap-4 mt-6 p-4 bg-gray-50 rounded-xl">
        <div className="text-center p-3 bg-surface rounded-lg"><div className="text-2xl md:text-3xl font-display font-bold text-brand-pink">{paragraphs}</div><div className="text-xs text-text-muted mt-1 uppercase">Paragraphs</div></div>
        <div className="text-center p-3 bg-surface rounded-lg"><div className="text-xl font-display font-semibold text-brand-cyan">{avgWords}</div><div className="text-xs text-text-muted mt-1 uppercase">Avg words/paragraph</div></div>
        <div className="text-center p-3 bg-surface rounded-lg"><div className="text-lg font-display font-medium">{words}</div><div className="text-xs text-text-muted mt-1 uppercase">Total Words</div></div>
      </div>
    </div>
  );
}
